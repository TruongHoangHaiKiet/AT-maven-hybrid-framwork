...
import pageFactory.user.HomePageObjects;
import pageFactory.user.LoginPageObjects;
import pageFactory.user.MyDashboardPageObjects;
...
public class Level_05_Selenium_Page_Factory extends baseTest { // Dùng kế thừa sẽ không cần thông qua object/ instance để call data nữa
	// Khai báo = Declare
	WebDriver driver;
