...
public class Level_23_Data_In_XML extends baseTest { // Dùng kế thừa sẽ không cần thông qua object/ instance để call data nữa
	// Khai báo = Declare
	WebDriver driver;
	...
	@Parameters({"browser", "emailAddress", "password", "firstName", "lastName"})
	@BeforeClass
	public void beforeClass(String browserName, String emailAddress, String password, String firstName, String lastName) {
