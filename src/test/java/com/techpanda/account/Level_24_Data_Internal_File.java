...
public class Level_24_Data_Internal_File extends baseTest { // Dùng kế thừa sẽ không cần thông qua object/ instance để call data nữa
	// Khai báo = Declare
	WebDriver driver;
	...
	public void beforeClass(String browserName) {
		...
		emailAddress = Account.Login.PRE_EMAIL_ADDRESS + getRandomNumber() + Account.Login.WEB_EMAIL_SERVER;
	...
	public void TC_02_LoginWithInvalidEmail() {
		...
		loginPage.inputToTextboxByID(driver, "pass", Account.Login.PASSWORD);
	...
	public void TC_05_Register_Success() {
		...
		registerPage.inputToTextboxByID(driver, "firstname", Account.Login.FIRSTNAME);
		registerPage.inputToTextboxByID(driver, "lastname", Account.Login.LASTNAME);
		registerPage.inputToTextboxByID(driver, "email_address", emailAddress);
		registerPage.inputToTextboxByID(driver, "password", Account.Login.PASSWORD);
		System.out.println("Password = " + Account.Login.PASSWORD);
		registerPage.inputToTextboxByID(driver, "confirmation", Account.Login.PASSWORD);
		System.out.println("Confirm Password = " + Account.Login.PASSWORD);
	...
	public void TC_07_LoginWithValidEmailAndPassword() {
		...
		log.info("Login_07: Input 'Password' field with value " + Account.Login.PASSWORD);
		loginPage.inputToTextboxByID(driver, "pass", Account.Login.PASSWORD);
		loginPage.clickButtonByTitle(driver, "Login");
		myDashboardPage = PageGeneratorManager.getMyDashboardPage(driver);	
		
		log.info("Login_07: Verify contact infor is displayed");
		Assert.assertTrue(myDashboardPage.getInfoContactText(Account.Login.FULLNAME));
