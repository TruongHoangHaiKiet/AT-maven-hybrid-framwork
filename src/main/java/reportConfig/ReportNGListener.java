...
public class ReportNGListener implements ITestListener {
	...
	public void onTestFailure(ITestResult iTestResult) {
		// Set False để trả về đúng format hình trong Report
		...
		String screenshotPath = captureScreenshotAsBase64(driver, iTestResult.getName()); // iTestResult.getName() lấy ra tên TC
		
		// Trạng thái của testcase là pass/ fail/ skip
	...
	public String captureScreenshotAsFile(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = GlobalConstants.REPORTNG_SCREENSHOT_PATH + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
